...
// Insert ONE already-approved job (state='approved'). The UNIQUE(source,
// external_job_id) constraint rejects a duplicate submission. Full cohort ingestion,
// idempotent-retry vs conflict resolution, and atomic batch insert are deferred to B2.
